...
declare function glob(pattern: string, cb: (err: Error | null, matches: string[]) => void): void;
declare function glob(pattern: string, options: glob.IOptions, cb: (err: Error | null, matches: string[]) => void): void;
